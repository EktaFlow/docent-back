...
var gqlSchema = gql`
  ...
  type Question {
    ...
    answered: Boolean
    answers: [Answer]
    # files === current files attached to question
    files: [File]
  }
  type Answer {
    _id: String
  ...
  type File {
    ...
    name: String
    questionId: Int
    # questions === list of questions that current file is attached to
    # questions: [Question]
  }
  input QuestionInput {
    _id: String
  ...
  type Query {
    ...
    # query that will allow us to load all files attached to a question
    getFiles(_id: String, questionId: Int): [File]
    # query that will allow us to load all questions associated with a file
    # circular dependency in mongoose file when adding [questionSchema] to file type getQuestions: [Question]
  ...
  type Mutation {
    ...
    addTeamMember(_id: String!, teamMembers: [String]): Assessment
